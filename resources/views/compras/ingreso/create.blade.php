	    ...
	    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
	        <div class="form-group">
	        	<label for="num_comprobante">Número Comprobante</label>
	          	<input type="text" name="num_comprobante" required value ="{{old('serie_comprobante')}}"" class="form-control" placeholder="Número Comprobante...">
	        </div>
	    </div>
	</div>
	<div class="row">
...
@push ('scripts')
	...
	<script >
		...
		function agregar(){
			...
			{
				alert("Error al ingresar los registros, revise los datos")
			}
		}
