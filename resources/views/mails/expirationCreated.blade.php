      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>
            	Te informamos que detectamos el folio No. {{$data1->id_header_folio}}</strong> fue creado pero no se enviado para su autorización, recomendamos procedas a eliminarlo debido a que el periodo de viaje es anterior a la fecha actual. 
            </p>
            <p>
            	We inform you that we detected the folio No. {{$data1->id_header_folio}}</strong> was created but not sent for authorization, we recommend you proceed to eliminate because the travel period is previous to current date.
            </p>
          </td>
          </tr>
        </table>
