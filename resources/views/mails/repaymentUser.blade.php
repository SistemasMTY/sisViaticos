      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>
              El departamento de Cuentas por Pagar ha autorizado la comprobación de gastos con el No de Folio <strong>{{$folioMail->id_header_folio}}</strong>, si cuentas con más solicitudes de viaje, se iniciara el trámite para el deposito del anticipo.
            </p>
            <p>
              The Accounts Payable department has authorized the verification of expenses with the No of Folio <strong>{{$folioMail->id_header_folio}}</strong>, if you have more requests for travel, the process for depositing the advance payment will begin.
            </p>
