...
<body>
  <table style="width: 90%; height: 134px;" border="0">
    ...
    <tr><td>
      <table width="100%" border="0">
        <tr>
          <td><a href="{{url('')}}/confirmExpenseGet/{{$data1->_token}}/token/{{$data1->id_header_folio}}/folio/si" class="boton_1">YES</a></td>
          <td><a href="{{url('')}}/confirmExpenseGet/{{$data1->_token}}/token/{{$data1->id_header_folio}}/folio/no" class="boton_2">NO</a></td>
        </tr>
      </table>
    </td></tr>
    <tr><td></td></tr>
