      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>The advance request with Folio Number <strong>{{$folioMail->id_header_folio}}</strong>, has been denied by <strong>{{$folioMail->NombreAuto}}</strong>, please review it and apply the necessary corrections.</p>
          </td>
        </tr>
      </table>
    </td></tr>
