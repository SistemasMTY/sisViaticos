      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>La solicitud de anticipo con el Folio Numero <strong>{{$data1->id_header_folio}}</strong>, ha sido denegada por <strong>{{$data1->autorizador}}</strong>, favor de revisarlo con Gerencia General.</p>
          </td>
        </tr>
      </table>
    </td></tr>
