      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>La solicitud de tu comprobación de Gastos del Viaje de Negocios con el Folio Numero <strong>{{$data2->id_header_folio}}</strong>, ha sido denegada por <strong>{{$data2->autorizador}}</strong>, favor de revisarlo con Gerencia.</p>
          </td>
        </tr>
      </table>
    </td></tr>
