      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>
              Te informamos que tu comprobación de gastos con No. De Folio <strong>{{$data1->id_header_folio}}</strong> ha sido deshabilitada, esto debido a cuentas con un retraso de <strong>{{$diff}}</strong> día(s), favor de comunicarse con Gerencia Administrativa para su reactivación.
            </p>
            <p>
              We inform you that your verification of expenses with No. De Folio <strong>{{$data1->id_header_folio}}</strong> has been disabled, this due to accounts with a delay of <strong>{{$diff}}</strong> day(s), please contact Administrative Management for reactivation.
            </p>
          </td>
          </tr>
        </table>
