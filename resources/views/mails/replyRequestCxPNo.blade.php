      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>La solicitud de anticipo con el Folio Numero <strong>{{$folioMail->id_header_folio}}</strong>, ha sido denegada por <strong>Cuentas por pagar</strong>, favor de revisarlo y aplicar las correcciones necesarias.</p>
            <p>The request for your verification of Expenses of the Business Trip with Folio Number<strong>{{$folioMail->id_header_folio}}</strong>, has been denied by <strong>Debts to pay</strong>, please review it and apply the necessary corrections.</p>
          </td>
          </td>
        </tr>
      </table>
