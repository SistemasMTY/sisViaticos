            ...
            <table align="center" class="container float-center"><tbody><tr><td>
              ...
              <table class="row"><tbody><tr>
                <th class="small-12 large-12 columns first last"><table><tr><th>
                  ...
                  <h1>Bienvenido {{$data['id_solicitante']}}</h1>


					<!--<p> Desea Confirmar la solicitud
					<a href="{{url('')}}/reviewGet/{{$data['_token']}}/token/{{$data['id_header_folio']}}/folio/si">Si</a>
					<br>
					Desea Denegar la solicitud
					<a href="{{url('')}}/reviewGet/{{$data['_token']}}/token/{{$data['id_header_folio']}}/folio/no">No</a>
					</p>-->
