      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>En hora buena, tu comprobación de Gastos del Viaje de Negocios con el Folio Numero <strong>{{$data1->id_header_folio}}</strong>, ha sido aprobada por <strong>{{$data1->autorizador}}</strong>.</p></br >
          </td>
        </tr>
      </table>
    </td></tr>
