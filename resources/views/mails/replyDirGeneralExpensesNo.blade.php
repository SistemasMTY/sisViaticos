      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>La comprobación de Gastos con el Folio Numero <strong>{{$data1->id_header_folio}}</strong>, ha sido denegada por <strong>{{$data1->autorizador}}</strong>, esta solicitud de anticipo queda canceladan favor de revisarlo con Gerencia y Gerencia General.</p>
          </td>
        </tr>
      </table>
    </td></tr>
