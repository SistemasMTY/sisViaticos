      ...
      <table align="center" border="0">
        <tr>
          @if($folioMail->id_status >= 15 )
            ...
            <p>En hora buena, tu comprobación de Gastos del Viaje de Negocios con el Folio Numero <strong>{{$folioMail->id_header_folio}}</strong>, ha sido aprobada por <strong>{{$folioMail->NombreAuto}}</strong></p>
            <p>In good time, your verification of Business Trip Expenses with Folio Number <strong>{{$folioMail->id_header_folio}}</strong>, has been approved.
            </p>
          </td>
          @else
          <td>
            <h1>Gracias por usar el Sistema ADViaticos.</h1>
            <p>En hora buena, tu comprobación de Gastos del Viaje de Negocios con el Folio Numero <strong>{{$folioMail->id_header_folio}}</strong>, ha sido aprobada por <strong>{{$folioMail->NombreAuto}}</strong>, esta comprobación queda en proceso de ser autorizada por el siguiente autorizador.</p>
            <p>In good time, your verification of Business Trip Expenses with Folio Number <strong>{{$folioMail->id_header_folio}}</strong>, has been approved  by <strong>{{$folioMail->NombreAuto}}</strong>, this check is in the process of being authorized by the following authorizer.
            </p>
          </td>
          @endif
        </tr>
