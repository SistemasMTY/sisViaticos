      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>El Departamento de Cuentas por Pagar ha autorizado un anticipo extraordinario para el Folio No. <strong>{{$data2->id_header_folio}}</strong> del usuario <strong>{{$data2->name}}</strong>.
            </p>
            <p>The Accounts Payable Department has authorized an extraordinary advance for Folio No. <strong>{{$data2->id_header_folio}}</strong> of user <strong>{{$data2->name}}</strong>.
            </p>
          </td>
        </tr>
      </table>
