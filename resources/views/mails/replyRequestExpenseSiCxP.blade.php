      ...
      <table align="center" border="0">
        ...
        @if($folioMail->id_status == 16 )
          <td>
            ...
            <p>En hora buena, tu comprobación de Gastos del Viaje de Negocios con el Folio Numero <strong>{{$folioMail->id_header_folio}}</strong>, ha sido aprobada por Cuentas por Pagar.</p>
            <p>In good time, your verification of Business Trip Expenses with Folio Number <strong>{{$folioMail->id_header_folio}}</strong>, has been approved by Debts to pay.
          </td>
        @else
          <td>
            <h1>Gracias por usar el Sistema ADViaticos.</h1>
            <p>En hora buena, tu comprobación de Gastos del Viaje de Negocios con el Folio Numero <strong>{{$folioMail->id_header_folio}}</strong>, ha sido aprobada por Cuentas por Pagar, se pasara al proceso de revision de autorizadores</p>
            <p>In good time, your verification of Business Trip Expenses with Folio Number <strong>{{$folioMail->id_header_folio}}</strong>, has been approved by Accounts Payable, it will pass to the review process of authorizers.
          </td>
        @endif
        </tr>
      </table>
