      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>En hora buena, tu solicitud de anticipo con el Folio Numero <strong>{{$data1->id_header_folio}}</strong>, ha sido aprobada por <strong>{{$data1->autorizador}}</strong>.</p></br >
            <p>In good time, your advance request with Folio Number <strong>{{$data1->id_header_folio}}</strong>, has been approved by <strong>{{$data1->autorizador}}</strong>.</p>
          </td>
        </tr>
      </table>
    </td></tr>
