      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>En hora buena, tu comprobación de Gastos del Viaje de Negocios con el Folio Numero <strong>{{$data2->id_header_folio}}</strong>, ha sido aprobada por <strong>{{$data2->autorizador}}</strong>, esta comprobación queda en proceso de ser autorizada por el Gerente General.</p></br >
          </td>
        </tr>
      </table>
    </td></tr>
