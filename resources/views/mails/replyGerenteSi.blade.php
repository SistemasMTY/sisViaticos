      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>En hora buena, tu solicitud de anticipo con el Folio Numero <strong>{{$data2->id_header_folio}}</strong>, ha sido aprobada por <strong>{{$data2->autorizador}}</strong>, esta solicitud de anticipo queda en proceso de ser autorizada por el Gerente General.</p></br >
            <p>In good time, your advance request with Folio Number <strong>{{$data2->id_header_folio}}</strong>, has been approved by <strong>{{$data2->autorizador}}</strong>, this advance request is in the process of being authorized by the General Manager.</p>
          </td>
        </tr>
      </table>
    </td></tr>
