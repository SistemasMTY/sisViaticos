      ...
      <table align="center" border="0">
        <tr>
          <td>
            ...
            <p>El Usuario <strong>{{$folioMail->name}}</strong>esta solicitando una comprobacio de Gastos del Viaje de Negocio con el No. Folio  <strong>{{$folioMail->id_header_folio}}</strong>.
            </p>
            </p>
          </td>
        </tr>
    ...
    <tr><td>
      ...
      <tr><td>
        <table border="0"  cellspacing="0">
          <tr>
            <td>
              <h3>Si desea ver el detalle de los gastos, por favor presiona <a href="{{url('')}}/accounting/comprobacion/{{$folioMail->id_header_folio}}">aquí</a></h3>
            </td>
          </tr>
        </table>
      </td></tr>
