				...
				<table id="datatable1" class="table table-striped table-bordered table-condensed table-hover">
					...
					<tr>
						...
						<td>
							...
							@if ($fol->status=='6SA' || $fol->status=='E'|| $fol->status<>'CXP')
							...
							@if ($fol->status=='6SA' || $fol->status=='E'|| $fol->status<>'CXP')
								...
								<a href="{{URL::action('CuentasXPagarController@report', $fol->folio)}}"><button class="btn btn-warning"><i class="fa  fa-file-excel-o" aria-hidden="true"></i> Reporte </button></a>	
							@else
